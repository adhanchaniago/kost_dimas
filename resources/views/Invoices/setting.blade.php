        ...
        @if($invoice_detail == NULL || $invoice_detail->isEmpty())
            {!! Form::open(['action' => 'InvoiceController@modifySettings', 'method' => 'POST']) !!}
                <div class="form-group">
                    ...
                    {{Form::text('vendor_no','',['class'=>'form-control'])}}
                </div>
                <div class="form-group">
                    {{Form::label('co_no', 'Co No.')}}
                    {{Form::text('co_no','',['class'=>'form-control'])}}
                </div>
                <div class="form-group">
                    {{Form::label('leg_code', 'LEG Approval Code')}}
                    {{Form::text('leg_code','',['class'=>'form-control'])}}
                </div>
                <div class="form-group">
                    {{Form::label('bill_to', 'Bill To')}}
                    {{Form::textarea('bill_to','',['class'=>'form-control'])}}
                </div>
                <div class="form-group">
                    {{Form::label('acc_bank', 'Bank Name')}}
                    {{Form::text('acc_bank','',['class'=>'form-control'])}}
                </div>
                <div class="form-group">
